...
private:
  ...
  Double_t fTowerEnergyLV; // tower energy from LV particles
  Double_t fTowerEnergyPU; // tower energy from PU particles
  Double_t fTrackEnergy;
  Double_t fTrackEnergyLV; // track energy from LV tracks
  Double_t fTrackEnergyPU; // track energy from PU tracks
