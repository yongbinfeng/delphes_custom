...
public:
  ...
  Float_t PuppiWeight; // PUPPI weights for gen particles
...
public:
  ...
  Int_t IsPU;
  Int_t IsRecoPU;
  Float_t ETruth; // truth particle energy
  Float_t ETruthLV; // truth particle energy from LV
  Float_t ETruthPU; // truth particle energy from PU
...
public:
  ...
  Int_t IsRecoPU;
  Float_t ETruth;
  Float_t ETruthLV; // calorimeter tower energy from the leading vertex
  Float_t ETruthPU; // calorimter tower energy from the pileup vertices
...
public:
  ...
  Int_t PdgID; // measured HEP ID at reco level
