...
Candidate::Candidate() :
  ...
  Charge(0), Mass(0.0),
  PdgID(0), IsPU(0), IsRecoPU(0), PuppiWeight(0), ETruth(0.), ETruthLV(0.), ETruthPU(0.),IsConstituent(0), IsFromConversion(0),
...
void Candidate::Copy(TObject &obj) const
{
  ...
  object.PuppiWeight = PuppiWeight;
  object.ETruth = ETruth;
  object.ETruthLV = ETruthLV;
  object.ETruthPU = ETruthPU;
